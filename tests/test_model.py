...
class TestQuestions(unittest.TestCase):
    ...
    def test_get_all_questions_is_correct(self):
        self.assertEqual(self.questions.get_all(), [{"id":1,"title":"class","question":"what is a class"}])
    
    def test_get_one_question(self):
        self.assertEqual(self.questions.get_one(1),{"id":1,"title":"class","question":"what is a class"})
    
    def test_remove_a_question(self):
        self.assertEqual(self.questions.delete_question(1), "Question successfully deleted")
